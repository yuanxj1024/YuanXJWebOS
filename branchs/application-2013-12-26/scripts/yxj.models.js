...
var WindosModel = function (args) {
    ...
    this.onControlBarClick = function () {
        ...
        $("#window_title_bar_l_" + _self.Item.appId + " .win_toolbar_close").on("click", function () {
            appWin.remove();
        ...
        $("#window_title_bar_l_" + _self.Item.appId + " .win_toolbar_mid").on("click", function () {
            resizeWindow();
        });
        $("#window_title_bar_l_" + _self.Item.appId + " .win_toolbar_min").on("click", function () {
            appWin.hide();
        });
    };
    ...
    var resizeWindow = function () {
        var appWin = $("#appWindow_" + _self.Item.appId);
        var screen = { width: $(window).width() - 13, height: $(window).height() - 35, top: 0, left: 0 },
